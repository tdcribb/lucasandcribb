...
In template files place:
 ...
 __`<?php if ( function_exists('flexible_frontend_login') ) flexible_frontend_login( $vertical, $horizontal ); ?>`__
...
1. Copy the file /flexible-frontend-login/css/ffl-style.css into it
...
* Find a solution to work with QTranslate 
* Add option to automatically place login link in header, sidebar or footer (JQuery, needs ID of aimed container)
